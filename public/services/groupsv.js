...
const getAll = (id_event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prisma.group.findMany({ where: { id_event } });
    }
    catch (error) {
        return false;
    }
...
const getOne = (filteres) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prisma.group.findFirst({ where: filteres });
    }
    catch (error) {
        return false;
    }
...
const add = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!eventItem)
            return false;
        return yield prisma.group.create({ data });
    }
    catch (error) {
        return false;
    }
...
const update = (filteres, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prisma.group.update({ where: filteres, data });
    }
    catch (error) {
        return false;
    }
...
const remove = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prisma.group.delete({ where: filters });
    }
    catch (error) {
        return false;
    }
